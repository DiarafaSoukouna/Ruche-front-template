      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card title="Performance par Catégorie">
          <BarChart
            ...
            xKey="category"
            series={[
              { yKey: 'sales', label: 'Ventes (€)', color: '#8B5CF6' }
            ]}
            height={300}
            axes={{
              yTitle: 'Ventes (€)',
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-right py-3 px-4 font-medium text-gray-600">Unités</th>
                  ...
                  <td className="text-right py-3 px-4">
                    <div className="w-20 bg-gray-200 rounded-full h-2 ml-auto">
                      <div
                        ...
                        style={{ width: `${Math.min((product.sales / 15600) * 100, 100)}%` }}
                      />
                    </div>
                  </td>
                </tr>
      ...
      <Card title="Alertes & Recommandations">
        <div className="space-y-4">
          <div className="flex items-start space-x-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <div>
              <h4 className="font-medium text-yellow-800">Stock faible détecté</h4>
              <p className="text-sm text-yellow-700 mt-1">
                3 produits ont un stock inférieur à 10 unités. Recommandation: réapprovisionner rapidement.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div>
              <h4 className="font-medium text-blue-800">Opportunité de croissance</h4>
              <p className="text-sm text-blue-700 mt-1">
                La catégorie "Électronique" montre une croissance de +15%. Considérez augmenter l'inventaire.
              </p>
            </div>
          </div>
        </div>
