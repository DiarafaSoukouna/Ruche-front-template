...
import { allProgram } from '../../../functions/Programme/gets'
                        ...
                        {programmes.map((prod) =>
                            <div className="col-span-4">
                                <Card
                                    ...
                                    className={`border-l-4 ${prod.actif_programme ? 'border-l-green-500' : 'border-l-gray-400'} relative overflow-hidden`}
                                    headerAction={
                                        <div className="flex space-x-2">
                                            
                                            <EditIcon color='blue' className="w-5 h-5 cursor-pointer" onClick={() => onEdit(prod)}  />
                                            <TrashIcon color='red' onClick={() => {
                                                handleDelete(prod);
                                ...
                                >
                                    <div className="space-y-4 p-2">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-lg text-gray-900 mb-1">{prod.nom_programme}</h3>
                                            <p className="text-sm text-gray-600">Sigle: {prod.sigle_programme}</p>
                                        </div>

                                        <div className="flex items-center text-sm text-gray-600">
                                            <CalendarIcon className="w-4 h-4 mr-2 text-blue-500" />
                                            <span>
                                                Du {new Date(prod.annee_debut_programme).toLocaleDateString('fr-FR') + ' au ' } 
                                                  {new Date(prod.annee_fin_programme).toLocaleDateString('fr-FR')}
                                            </span>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    <p className="text-sm font-medium text-gray-800">Objectif</p>
                                                    <p className="text-sm text-gray-600 truncate">{prod.objectif_programme}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    <p className="text-sm font-medium text-gray-800">Vision</p>
                                                    <p className="text-sm text-gray-600 truncate">{prod.vision_programme}</p>
                                                </div>
                                            </div>
                                        </div>
