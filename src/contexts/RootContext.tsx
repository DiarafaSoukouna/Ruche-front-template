...
import { getAllProgrammes } from "../functions/programme";

interface contextType {
    currentProgramme: Programme | undefined;
    setCurrentProgramme: React.Dispatch<React.SetStateAction<Programme | undefined>>;
...
export const RootProvider = ({ children }: { children: React.ReactNode }) => {
    const [currentProgramme, setCurrentProgramme] = useState<Programme | undefined>(undefined);
    ...
    useEffect(() => {
        currentProgramme && localStorage.setItem("currentProgramme", JSON.stringify(currentProgramme));
    }, [currentProgramme]);
