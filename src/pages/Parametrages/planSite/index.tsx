...
import {
  allNiveauStructure,
  oneNiveauStructure,
} from '../../../functions/niveauStructures/gets'
  ...
  return (
    <>
      ...
      <Modal
        ...
        isOpen={loadNiveau}
        title="Espace de configuration des niveaux de structure"
        size="lg"
      >
                    ...
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        {niveauStructures
                          ...
                          .sort((a, b) => b.nombre_nsc - a.nombre_nsc)
                          .map((niv) => (
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">
                              {niv.libelle_nsc}
                            </th>
                            ...
                            >
                                ...
                                .map((niv, index) => (
                                  ...
                                  >
                                    {parentHierarchy[index]
                                      ? parentHierarchy[index].intutile_ds
                                      : '-'}
                                  </td>
                                ))}
                              <td
                              ...
                              >
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() => (
                                    setEditRow(plan), setShowForm(true)
                                  )}
                                >
      ...
      >
        <FormPlanSite
          ...
          currentId={currentId}
          niveauStructures={niveauStructures}
          editRow={editRow || null}
          planByNiveau={OneNiveau}
        />
      </Modal>
      <ConfirmModal
        isOpen={isDelete}
