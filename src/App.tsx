      ...
      <main className={isAuthenticated ? "px-4 sm:px-6 lg:px-8 py-8" : ""}>
        <Routes>
          ...
          <Route
            path="/suivi-ptba"
            element={
              isAuthenticated ? <SuiviPtbaPage /> : <Navigate to="/login" />
            }
          />
          <Route
            path="/indicateur_performance_projet"
            element={
              isAuthenticated ? (
                <IndicateurPerformanceProjetPage />
              ) : (
                <Navigate to="/login" />
              )
            }
          ...
          />
          <Route
            path="/activite_programme"
            element={
              isAuthenticated ? (
                <ActiviteProgrammePage />
              ) : (
                <Navigate to="/login" />
              )
            }
